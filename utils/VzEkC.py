...
class VzEkC:
    ...
    def _print_result(self, *, text, names):
        ...
        self.out(f'Gewinner ist: '
                     f'*** {self.rnd.choice(names)} ***')
...
post_timestamp = 1601933809 (Use pseudo-random number generator Version 3 with seed='2ed05778e97b0f4497673ac0994c05964c0df25ae92e5f0cf97dbb02ef06850829b74f2e2c3cce0edb2454efaa6e3c5ac228a219a3cc838cff9db81765c02386')
